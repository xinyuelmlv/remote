...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.username-label-sliding, .password-label-sliding').animate({
			opacity : "0.4"
		}).click(function() {
			var thisFor = $(this).attr('for');
			$('.' + thisFor).focus();
...
<script type="text/javascript">
	...
	$.ajax({
		...
		success : function(data) {
			if (data == 1) {
				window.location.href="http://www.fengling-tech.com.cn/maple-earnings-web/AuthCheck/returnlogin";	
	...
	function houtaiguanli() {
		window.location.href = "http://www.fengling-tech.com.cn/maple-earnings-web/AuthCheck/adminLogin";
...
<body>
	<form class="contact_form" action="#" method="post" name="contact_form">
		<ul>
			<li>
				<h2>联系信息</h2> <span class="required_notification">*
					表示必填项</span>
			</li>
			<li><label for="name">姓名:</label> <input type="text" id="name"
				placeholder="联系人姓名" required /></li>
			<li><label for="email">电子邮件:</label> <input type="email" id="email"
				name="email" placeholder="****@**.com" required /> <span
				class="form_hint">正确格式为：***@**.com</span></li>
				<li><label for="name">联系人电话:</label> <input type="text" id="tel"
				name="tel" placeholder="联系人电话" required /> <span
				class="form_hint">正确格式为：11位有效的手机号码</span></li>
				<li><h2>发票信息</h2></li>
					<li><label for="name">公司名称:</label> <input type="text" id="companyName"
				name="companyName" placeholder="公司名称" required /> <span
				class="form_hint">正确格式为：有效英文或者汉字</span></li>
				<li><label for="name">纳税人识别号:</label> <input type="text" id="nashui"
				name="companyName" placeholder="纳税人识别号" required /> <span
				class="form_hint">请输入纳税人识别号</span></li>
					<li><label for="name">开户行账号:</label> <input type="text" id="kaihu"
				name="companyName" placeholder="开户行账号" /> <span
				class="form_hint"></span></li>
					<li><label for="message">公司地址:</label> <textarea name="message" id="addr"
					cols="40" rows="4" placeholder="公司地址" required></textarea></li>
			<li>
