...
public class OrderReportServiceImpl implements OrderReportService {
	...
	public void saveOrUpdate(OrderReport orderReport) {
		if (this.load(orderReport.getTid(),orderReport.getUserId()) == null) {
	...
	public OrderReport load(String tid,String userId) {
		return this.orderReportMapper.selectByPrimaryKey(tid,userId);
	}
	...
	public List<OrderReportDTO> listOrderReportDTOByTid(String tid,String userId) {
		ETrade trade = this.tradeService.load(tid,userId);
		List<OrderReportDTO> orderReportDTOs = new ArrayList<>();
		OrderReportDTO orderReportDTO = null;
		List<EOrder> orders = this.orderService.listOrderAndRefund(tid,userId);
